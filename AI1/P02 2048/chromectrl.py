...
class ChromeDebuggerControl(object):
    ...
    # Vielleicht so Chrome mit dem Terminal starten?
    # /Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --remote-debugging-pt=9222
    # oder mit der Chrome Debugger App
